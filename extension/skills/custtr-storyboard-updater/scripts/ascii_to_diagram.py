...
Public API (stable — used by create_additions_deck.py):
...
returns whatever boxes/connectors it could recover. The caller (e.g.
layout_ascii_diagram) falls back only if the box list is empty.
"""
